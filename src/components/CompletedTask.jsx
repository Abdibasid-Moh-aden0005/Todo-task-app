...
const CompletedTask = () => {
  ...
  return (
    <div className="  px-2 py-3 my-4 flex flex-col items-center justify-center ">
      <div className="w-full text-start md:text-center my-2 ">
        <h2 className=" text-2xl font-semibold text-gray-500 tracking-wide">
          Completed Task :
        </h2>
      </div>
      <table className="w-full sm:w-2/3 px-2 bg-white border-collapse rounded shadow-lg">
        <thead className="bg-linear-to-r from-green-200 to-green-600 text-white rounded">
          <tr>
